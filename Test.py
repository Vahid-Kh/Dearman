...
print('All TDN states are defined by pressure as p, and enthalpy as h and the selected refrigerant'
...
A = TDN(1e5, 0, 300, 0, 0, 'H2')
B = TDN(7e7, 0, 300, 0, 0, 'H2')
# A = TDN(3e7, 0, 300, 0, 0, 'Methane')
# B = TDN(10e5, 0, 110, 0, 0, 'Methane')

# A = TDN(1e5, 0, 300, 0, 0, 'R22')
# print(1000/A.d*0.85, B.d)
# print(A.d, B.d, 8.313/A.cp()/A.m())

# A = TDN(7e7, 0, 800, 0, 0, 'Hydrogen')
# B = TDN(1e7, A.h, 0, 0, 0, 'Hydrogen')
#
# A = TDN(1e5, 0, 600, 0, 0, 'Water')
# A = TDN(1e5, 0, 300, 0, 0, 'Water')
# A = TDN(1e7, 0, 300, 0, 0, 'Air')
# print(A.d)
# AA = TDN(20e5, 0, 250, 0, 0, 'R22')
# print(A.d)
# print(A.ex()-B.ex())

# print(A.cv(), A.cp())
# print(A.p/A.d*np.log(A.d/B.d))
...
A = TDN(78e5, 0, 304, 0, 0, 'CO2')
B = TDN(76e5, 0, 304, 0, 0, 'CO2')
